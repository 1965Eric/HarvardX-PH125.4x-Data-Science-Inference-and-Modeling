...
#### Question 3: Consider the first poll in ```brexit_polls```, a YouGov poll run on the same day as the Brexit referendum:
...
#### Question 6: Make a boxplot of the spread in ```june_polls``` by poll type.
