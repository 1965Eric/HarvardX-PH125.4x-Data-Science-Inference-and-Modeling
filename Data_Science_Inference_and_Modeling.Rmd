...
- [ ] B. There is no flaw. The multiplicative rule always applies in this way: $Pr(\mod{A and B}) = Pr(A)Pr(B)$
- [ ] C. Sir Meadow should have added the probabilities: $Pr(\mob{A and B}) = Pr(A) + Pr(B)$
- [ ] D. The rate of SIDS is too low to perform these types of statistics.

2. Let's assume that there is in fact a genetic component to SIDS and the the probability of $Pr(\mod{second case of SIDS} \mid \mod{first case of SIDS}) = 1/100$, is much higher than 1 in 8,500.
...
$Pr(\mod{mother is a murderer} \mid \mod{two children found dead with no evidence of harm})$

Bayes' rule tells us this probability is equal to:

- [ ] A.  $\frac{Pr(\mod{two children found dead with no evidence of harm})Pr(\mod{mother is a murderer})}{Pr(\mod{two children found dead with no evidence of harm})$
- [ ] B.  $Pr(\mod{two children found dead with no evidence of harm})Pr(\mod{mother is a murderer})$
- [X] C.  $\frac{Pr(\mod{two children found dead with no evidence of harm} \mid \mod{mother is a murderer})Pr(\mod{mother is a murderer})}{Pr(\mod{two children found dead with no evidence of harm})$
- [ ] D. 1/8500
...
$Pr(\mod{two children found dead with no evidence of harm} \mid \mod{mother is a murderer}) = 0.50$

Assume that the murder rate among mothers is 1 in 1,000,000.

$Pr(\mod{mother is a murderer}) = 1/1,000,000
